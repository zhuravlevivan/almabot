...
from handlers.admin import admin_cmd, remove_cmd, rename_cmd,\
    users_cmd, giving_access, delete_access,\
    cancel_handler, process_new_name_step, process_old_name_step,\
    process_file_remove_step, process_file_name, process_get_file,\
    process_delete_file_name, process_delete_user_id, process_user_id,\
